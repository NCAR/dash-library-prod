...
path1 = '.'
if(path.exists("library_gcmd.txt")):
    os.remove("library_gcmd.txt")
fo = open("library_gcmd.txt", "w+")
...
# with open('library_gcmd.txt') as f:
#     seen = set()
#     for line in f:
...
if(path.exists("library_gcmd_counts_levels.txt")):
    os.remove("library_gcmd_counts_levels.txt")

sys.stdout = open("library_gcmd_counts_levels.txt", "w")
